    ...
    return(
        <View style={styles.background}>
            ...
            <ScrollView>
                ...
                <View style={styles.boarder}/>
                <TouchableHighlight onPress={()=>{setLan({...all,lan:'Chinese (Taiwan)'}); return null;}} style={styles.touch} underlayColor='black'>
                    <View style={{flexDirection: 'row', justifyContent:'flex-start',alignItems:'center'}}>
                ...
                <View style={styles.boarder}/>
                <TouchableHighlight onPress={()=>{setLan({...all,trans:'Chinese (Taiwan)'}); return null;}} style={styles.touch} underlayColor='black'>
                    <View style={{flexDirection: 'row', justifyContent:'flex-start',alignItems:'center'}}>
                        <Text style= {styles.text}>中文 (台湾)</Text>
                        <Image source={require('../../assets/select.png')} style={{
                            resizeMode: 'contain',
